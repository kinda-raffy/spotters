...
#include <spot_slam/SaveMap.h> // This file is created automatically, see here http://wiki.ros.org/ROS/Tutorials/CreatingMsgAndSrv#Creating_a_srv
...
bool save_map_srv(spot_slam::SaveMap::Request&, spot_slam::SaveMap::Response&);
bool save_traj_srv(spot_slam::SaveMap::Request&, spot_slam::SaveMap::Response&);
